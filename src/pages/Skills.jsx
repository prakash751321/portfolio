...
function Skills() {
  const skills = [
    { name: "C", icon: <BsCSquare className="text-black" /> },
    { name: "J2SE", icon: <FaJava className="text-blue-400" /> },
    { name: "J2EE", icon: <FaJava className="text-blue-400" /> },
    ...
    { name: "Operating Systems", icon: <GrSystem /> },
      ...
      <div className="container mx-auto px-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="flex flex-col items-center bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out"
            >
