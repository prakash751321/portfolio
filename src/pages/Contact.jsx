    ...
    <section id="contact" className="bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center">
          <a
            href="mailto:jyotiprakash751321@gmail.com"
      ...
      <div className="mt-8 flex justify-center space-x-4">
        <a
          href="https://www.linkedin.com/in/jyoti-prakash-nayak-0bb486154"
        ...
        <a
          href="https://github.com/prakash751321?tab=repositories"
        ...
        <a
          href="https://www.instagram.com/prakash__gudu?igsh=eGpzZ2Z3ZW1jbDM1"
